...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "a2dedfce-d781-4bde-9d9e-2b218552b001",
...
const _BN5B2H = defineCachedEventHandler(async (event) => {
...
const _rJ4AM5 = lazyEventHandler(() => {
...
const _lazy_CZuYc4 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_CZuYc4, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _BN5B2H, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _rJ4AM5, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CZuYc4, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, createRouter$1 as A, defu as B, withTrailingSlash as C, withoutTrailingSlash as D, useRuntimeConfig as a, buildAssetsURL as b, getResponseStatus as c, defineRenderHandler as d, publicAssetsURL as e, getQuery as f, getResponseStatusText as g, createError$1 as h, getRouteRules as i, defuFn as j, klona as k, hasProtocol as l, isScriptProtocol as m, joinURL as n, getContext as o, parseQuery as p, baseURL as q, createHooks as r, sanitizeStatusCode as s, toNodeListener as t, useNitroApp as u, isEqual as v, withQuery as w, stringifyParsedURL as x, stringifyQuery as y, toRouteMatcher as z };
