import { hasInjectionContext, getCurrentInstance, defineAsyncComponent, createApp, provide, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, inject, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { k as klona, j as defuFn, h as createError$1, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch$1, q as baseURL, e as publicAssetsURL, r as createHooks, v as isEqual, x as stringifyParsedURL, y as stringifyQuery, p as parseQuery, z as toRouteMatcher, A as createRouter, B as defu } from '../_/nitro.mjs';
...
import { gsap as gsap$3 } from 'gsap';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
var gsap$2,
  ...
  return gsap$2 || "undefined" !== "undefined";
},
    _startup$1 = 1,
    _observers = [],
    _scrollers = [],
...
_revertRecorded = function _revertRecorded(media) {
  ...
  _docEl$1 = _doc$1.documentElement; // some frameworks like Astro may cache the <body> and replace it during routing, so we'll just re-record the _docEl and _body for safety (otherwise, the markers may not get added properly).
  ...
  _triggers.forEach(function (t) {
    ...
    var max = _maxScroll$1(t.scroller, t._dir),
  ...
  _proto.init = function init(vars, animation) {
    ...
    self.refresh = function (soft, force, position, pinOffset) {
      ...
      var size = getScrollerSize(),
          ...
          max = containerAnimation ? containerAnimation.duration() : _maxScroll$1(scroller, direction),
      ...
      if (clipped !== prevProgress && self.enabled) {
        ...
        if (pin) {
          ...
          if (!useFixedPosition) {
            ...
            isAtMax = !reset && clipped > prevProgress && end + 1 > scroll && scroll + 1 >= _maxScroll$1(scroller, direction); // if it's at the VERY end of the page, don't switch away from position: fixed because it's pointless and it could cause a brief flash when the user scrolls back up (when it gets pinned again)
...
_inputObserver$1 = function _inputObserver(target, type, inputs, nested) {
  ...
  var _vars2 = vars,
    ...
    return momentum || 2.8;
      ...
      lastRefreshID,
      skipTouchMove,
      inputObserver = _inputObserver$1(target, vars.type, true, allowNestedScroll),
              ...
              if (i) {
                ...
                while (i--) {
                  ...
                  if (pin.trig.isActive || scrollY >= pin.start && scrollY <= pin.end) {
                    ...
                    if (scrub) {
                      pin.trig.progress += pin.trig.direction < 0 ? 0.001 : -1e-3; // just to make absolutely sure that it renders (if the progress didn't change, it'll skip)
...
const LazyIcon = defineAsyncComponent(() => import('./index-Dafqu-4x.mjs').then((r) => r["default"] || r.default || r));
...
const _imports_0 = publicAssetsURL("/picture.png");
const _imports_1 = publicAssetsURL("/gallery/2.jpg");
const _imports_2 = publicAssetsURL("/gallery/3.jpg");
const _imports_3 = publicAssetsURL("/gallery/4.jpg");
const _imports_4 = publicAssetsURL("/gallery/5.jpg");
const _imports_5 = publicAssetsURL("/gallery/6.jpg");
const _imports_6 = publicAssetsURL("/gallery/7.jpg");
const _imports_7 = publicAssetsURL("/gallery/8.jpg");
const _imports_8 = publicAssetsURL("/gallery/9.jpg");
const _imports_9 = publicAssetsURL("/gallery/10.jpg");
const _imports_10 = publicAssetsURL("/gallery/11.jpg");
const _imports_11 = publicAssetsURL("/gallery/12.jpg");
const _imports_12 = publicAssetsURL("/gallery/13.jpg");
const _imports_13 = publicAssetsURL("/gallery/14.jpg");
const _imports_14 = publicAssetsURL("/gallery/15.jpg");
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    gsap$3.registerPlugin(ScrollTrigger$1, ScrollSmoother);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "wrapper" }, _attrs))}><div id="content"><header class="main-header"><div class="layers"><div class="layer__header"><div class="layers__caption">художник-акварелист</div><div class="layers__title">Юлия Калашникова</div></div><div class="layer layers__base"></div><div class="layer layers__middle"></div><div class="layer layers__front"></div></div></header><article class="main-article"><div class="main-article__content"><h2 class="main-article__header"> Обо мне</h2><p class="main-article__paragraph">Художник-акварелист. Основная техника - акварель, жанр - пейзаж, сюжет - сельские и городские мотивы с архитектурой. Мне нравится рисовать на пленэре, делать наброски и быстрые этюды. <br> <br> Я работала в палехских мастерских «Духанин» и «Возрождение», в багетной мастерской, на росписях(сусальное золото), преподавала в художественной мастерской и также занималась росписью по дереву. <br> Участвую в рисовальных марафонах, конкурсах. Посещала Вечерние Рисовальные Классы при Академии художеств, мастер-классы акварелистов. <br> <br> В данный момент проживаю в Санкт-Петербурге, занимаюсь акварельной живописью, графикой, веду блог, пишу на заказ, провожу мастер-классы и преподаю в школе «Художник онлайн». </p><a href="https://drive.google.com/file/d/1T4IdZAW7OI-wb_ZIIHUJKdBopLUmu5KO/view?usp=sharing" download="Свободные картины"><img class="main-article__picture"${ssrRenderAttr("src", _imports_0)} alt="alt"></a></div><div class="copyright">© Kalashyulya 2025</div></article><article class="gallery"><div class="gallery__content"><div class="item"><img${ssrRenderAttr("src", _imports_1)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_2)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_3)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_4)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_5)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_6)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_7)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_8)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_9)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_10)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_11)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_12)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_13)} alt="alt"></div><div class="item"><img${ssrRenderAttr("src", _imports_14)} alt="alt"></div></div></article></div></div>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BCHwIUrE.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DakgeLNs.mjs'));
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useAppConfig as d, entry$1 as default, asyncDataDefaults as e, createError as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
